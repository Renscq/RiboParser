...
|---|---|---|
| `bg2meta` | Expand bedGraph intervals into per-nucleotide signal rows. | Tab-delimited signal table. |
| `rpm_smooth` | Smooth RPM density in a bedGraph file with Savitzky-Golay or Gaussian filtering. | Smoothed bedGraph file. |
