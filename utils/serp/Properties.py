...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser SeRP functions for Properties analysis.
...
class SeqProperties(object):
    ...
    def __init__(self, seq):
        """Sequence properties calculation.
        ...
        - ``output``: sequence propeerties.

        Workflow
        --------
        1. Run ProteinAnalysis.
        """
...
class Sequence(object):
    ...
    def count_codons_numpy(self, cds_sequence):
        ...
        Workflow
        --------
        1. Split the cds sequence to codon sequence.
        2. Summary the codon count.
        """
    ...
    def create_codon_table(self):
        """Create the codon and amino acid table.
        ...
        Legacy return information:
        - ``output``: self.cds_data_frame.

        Workflow
        --------
        1. Summary the codon and count of cds sequence.
        2. Merge all gene codon count to one data table.
        """
    ...
    def calc_gene_codon_usage(self):
        ...
        -----
        Legacy input information:
        - ``param``: self.cds_data_frame.

        Legacy return information:
        - ``output``: Frequency, RSCU, CAI.

        Workflow
        --------
        1. Calculate the codon frequency.
        2. Calculate the RSCU and CAI.
        3. Fill NA with 0 and round the value.
    ...
    def protein_analysis(self):
        ...
        Legacy return information:
        - ``output``: sequence properties.

        Workflow
        --------
        1. Read the fasta file.
        2. Write the sequence properties to file.
        """
