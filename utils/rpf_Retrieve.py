...
def _run_retrieve_pipeline(args: Namespace) -> None:
    ...
    _print_step(2, "Retrieve the selected transcript RPF density.")
    rpfs.retrieve_rpf()
    rpfs.rpf_to_rpm()

    _print_step(3, "Format the RPF density table.")
    rpfs.melt_rpf_table()

    _print_step(4, "Output the retrieved RPF density table.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    now_time()
    print("\nRetrieve selected transcript RPF density profiles.", flush=True)
