...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Shift analysis.
...
class Shift(object):
    ...
    def calc_3nt_period(self):
        """Each gene 3nt periodicity calculation.
        ...
        -----
        Legacy input information:
        - ``param``: rpf density file.

        Legacy return information:
        - ``output``: summary the 3nt periodicity of each gene.

        Workflow
        --------
        1. Calculate the count of each frame of samples.
        2. Calculate the ratio of each frame of samples.
        """
    ...
    def filter_frame_shift(self):
        ...
        Workflow
        --------
        1. Calculate the frame shifting ratio of each gene.
        2. Filter the frame shifting genes of each sample.
        """
