...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Odd Ratio analysis.
...
class OddRatio(object):
    ...
    def read_rpf(self):
        ...
        3. . drop the codon without RPFs coverage.
        4. . fill the empty codon rpm value with minimal rpm value (>0),.
        """
    ...
    def make_two_dimensional_table(self):
        """Prepare two dimensional table for fisher exactly test.
    ...
    def calc_odd_ratio_v1(self):
        """Fisher exactly test with fisher package. package fisher were developed with python version < 3.9.
        ...
        -----
        Legacy input information:
        - ``self.dim2_df``: two dimension table for fisher-exactly test.

        Legacy return information:
        - ``control``: rpm of control.
        - ``treat``: rpm of treat.
    ...
    def calc_odd_ratio(self):
        """Calculate the odd ratio and pvalue with chi2-test.
    ...
    def calc_chi2_test(self):
        ...
        Legacy return information:
        - ``self.high_rpf``: contain the high rpf and odd-ratio and pvalue.

        Workflow
        --------
        1. Calculate the odd ratio and pvalue.
        2. Merge all results into one table.
        """
    ...
    def calc_chi2_test2(self):
        """Calculate the chi2-test odd ratio and pvalue with multiple progress.

        Returns
        -------
        object
            contain the high rpf and odd-ratio and pvalue.
        ...
        Workflow
        --------
        1. Define the function to calculate the pvalue with multiple progress.
        2. Calculate the odd ratio and pvalue.
        3. Correct the pvalue with Benjamin-Hochberg.
    ...
    def summarize_odd_ratio(self):
        ...
        Legacy return information:
        - ``count_aa_odd``: the count of codon odd ratio.
        - ``per_aa_odd``: the proportion of codon odd ratio.

        Workflow
        --------
        1. Filter the significant codon odd ratio.
        2. Calculate the count of significant codon odd ratio.
        3. Calculate the proportion of significant codon odd ratio.
        """
        # output filename
