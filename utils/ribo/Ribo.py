...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Ribo analysis.
...
class Ribo(object):
    ...
    def read_transcript(self):
        """Import the gene sequence and message.
        ...
        Workflow
        --------
        1. Import the mrna sequence generate from rpf_Reference script.
        - contains: [5'-utr, cds, 3'-utr].
        2. Import the gene message generate from rpf_Reference script.
    ...
    def check_transcript(self):
        ...
        Workflow
        --------
        1. Iterate the mrna_dict.
        2. Check the transcript length equal to the sequence length.
        3. Print the warning message if not equal.
        4. Remove the transcript if not equal.
        """
    ...
    def read_offset(self):
        """Import the offset and check the type of sequencing profile.
        ...
        -----
        Legacy input information:
        - ``psite``: the offset file.

        Legacy return information:
        - ``self.offset``: the offset dictionary.

        Workflow
        --------
        1. Import the offset generate from the rpf_Offset script.
        2. Retrieve the psite form offset file.
        3. Check the type of sequencing profie from offset file.
        """
        ...
        # New offset files generated by the enhanced rpf_Offset contain confidence and warning columns.
        # Keep backward compatibility: old offset files without these columns are still accepted.
    ...
    def monosome_p_site(self):
        """Retrieve the psite from each reads.
        ...
        -----
        Legacy input information:
        - ``pysam_input``: the mapping bam file interface.
        - ``mrna_dict``: the gene message.
        ...
        Workflow
        --------
        1. Import the gene mapping bam file.
        2. Delete the reads not in the specified range.
        3. Retrieve the psite from each reads.
        """
    ...
    def flt_star_results(args):
        """Filter the bam file generated by STAR.
        ...
        -------
        object
            the dict of length distribution the dict of sequence profile.

        Notes
        -----
        Legacy input information:
        - ``bam_in_file``: the path of input bam file.
        ...
        --------
        1. Open the bam file.
        2. Read the bam file and store the information into a dict.
        3. Calculate the length distribution.
        4. Output the filtered bam file.
        """
    ...
    def read_bam(self):
        """Import the mapping bam file.

        Notes
        -----
        Legacy input information:
        - ``bam``: the mapping bam file.
    ...
    def format_rpf_density(args):
        """Format the rpf density to long data.
        ...
        -------
        object
            the long data in pandas dataframe format.

        Notes
        -----
        Legacy input information:
        - ``gene_list``: the gene list.
        - ``mrna_dict``: the gene message.
        - ``out_prefix``: the output prefix.

        Workflow
        --------
        1. Retrieve the gene message from the rpf density.
        2. Check the 3nt periodicity and trim the utr length.
        3. Format the gene message to the long data.
        4. Format the rpf density to three columns.
        5. Return the long data.
        """
    ...
    def run_format_rpf_with_multi_thread(self):
        ...
        -----
        Legacy input information:
        - ``self.mrna_dict``: the gene message.
        - ``self.thread``: the number of thread.

        Legacy return information:
        - ``self.total_rpf_df``: the long data in pandas dataframe format.

        Workflow
        --------
        1. Split the gene list into several sub-list.
        2. Run the format_rpf_density function with multi-thread.
