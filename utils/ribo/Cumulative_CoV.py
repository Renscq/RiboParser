...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Cumulative CoV analysis.
...
class CumulativeCoV(object):
    ...
    def retrieve_rpf(self):
        ...
        - ``self.raw_rpf``: rpf table contain all rpf value.
    ...
    def rpf_to_rpm(self):
        ...
        -----
        Legacy input information:
        - ``high_rpf``: rpf table in pandas dataframe.
        - ``norm``: default [False].
    ...
    def melt_rpf_table(self):
        """Melt the data into a format that is convenient for drawing.
        ...
        -----
        Legacy input information:
        - ``self.high_rpf``: specific genes rpf table.

        Legacy return information:
        - ``self.melt_rpf``: melt the three frame data to long data format.
        - from.
    ...
    def calc_cov(self):
        ...
        -------
        object
            coefficient of variation table from gene site a b x 1 4 5 x 2 5 5 x 3 10 1 x
            4 3 0 x 5 10 3 x 6 1 4 x 7 9 1 x 8 4 2 x 9 7 3 x 10 2 2 y 1 5 3 y 2 2 1 y 3
            3 4 y 4 4 4 y 5 5 1 y 6 6 2 y 7 4 2 y 8 6 4 y 9 7 1 y 10 5 3 y 11 3 0 y 12 5
            1 to gene site a b x 1 nan 0 x 2 0.15713484 0 x 3 0.507560566 0.514259477 x
            4 0.5652957 0.828221234 x 5 0.52524176 0.728431359 x 6 0.677867341
            0.638284739 x 7 0.608580619 0.702192845 x 8 0.600656765 0.685118789 x 9
            0.553155291 0.637377439 x 10 0.601497977 0.624926031 y 1 0 0 y 2 0.333333333
            0.428571429 y 3 0.40824829 0.374165739 y 4 0.447213595 0.319438282 y 5
            0.471404521 0.306892205 y 6 0.487950036 0.32249031 y 7 0.5 0.30061372 y 8
            0.509175077 0.301018679 y 9 0.516397779 0.319438282 y 10 0.522232968
            0.301647806 y 11 0.527046277 0.316227766 y 12 0.531085005 0.301511345.

        Notes
        -----
        Legacy input information:
        - ``self.gene_rpf``: rpf table.
        """
    ...
    def merge_cov_table(self):
        """Merge the coefficient of variation table.
    ...
    def output_rpf_table(self):
        """Split merged rpf table to each file.
        ...
        -----
        Legacy input information:
        - ``self.melt_rpf``: description.

        Legacy return information:
        - ``output``: output rpf table in txt format.
        """
