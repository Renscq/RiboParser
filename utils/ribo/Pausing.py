...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Pausing analysis.
...
class Pausing(object):
    ...
    def output_sum_codon_pausing(self):
        """Output the sum of codon pausing score.
        ...
        - ``self.high_rpf``: high express gene rpf.

        Legacy return information:
        - ``self.codon_pausing``: codon pausing score.

        Workflow
        --------
        1. Summary the total and valid codon number.
        2. Summary the pausing score.
        3. Calculate the relative pausing score.
        4. Merge pausing score of total and valid codon.
        """
    ...
    def draw_codon_total_pausing_heat(self):
        """Draw the codon total pausing score heatmap.
        ...
        Legacy return information:
        - ``output``: codon total pausing score heatmap.

        Workflow
        --------
        1. Select the column of total pausing score.
        2. Draw the heatmap.
        """
    ...
    def draw_codon_valid_pausing_heat(self):
        ...
        Legacy return information:
        - ``output``: codon valid pausing score heatmap.

        Workflow
        --------
        1. Select the column of valid pausing score.
        2. Draw the heatmap.
        """
