...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for CDT analysis.
...
class CodonDecodingTime(object):
    ...
    def calc_rpf_norm(self):
        ...
        -----
        Legacy input information:
        - ``self.high_rpf``: high expression gene rpf density.

        Legacy return information:
        - ``self.rpf_norm_dst``: normalized rpf density with RNA-seq RPKM.

        Workflow
        --------
        1. Calculate the average density and normalized rpf density of each codon.
        2. Merge average density.
        """
    ...
    def codon_decoding_time(self):
        """Codon decoding time calculatioin.
        ...
        1. Merge all norm.
        2. Calculate cdt.
        3. Calculate relative cdt.
        4. Output the cdt table.
        """
