...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for RNA analysis.
...
class RNA(object):
    ...
    def read_transcript(self):
        ...
        - ``self.mrna_file``: mrna message table generated by riboParser.
        - ``self.mrna_seq``: mrna sequence file.

        Legacy return information:
        - ``self.mrna_dict``: mrna dict contain the mrna message.

        Workflow
        --------
        1. Read the mrna sequence file.
        2. Read the mrna message file.
    ...
    def read_offset(self):
        ...
        -----
        Legacy input information:
        - ``self.psite``: input offset file name.

        Legacy return information:
        - ``self.offset``: offset dictionary.

        Workflow
        --------
        1. Read the offset file.
        2. Drop the null value.
        3. Change the offset type to int.
        """
    ...
    def read_bam(self):
        ...
        Workflow
        --------
        1. Check the input file format.
        2. Read the bam file.
        3. Check the bam index.
        4. Build the bam index.
        """
    ...
    def mono_density(self):
        """Calculate the reads monosome density.
        ...
        Legacy return information:
        - ``self.mrna_dict``: mrna dict contain the mrna message and reads density.

        Workflow
        --------
        1. Delete the unmapped reads.
        2. Delete the reverse reads.
        3. Filter the reads length.
        4. Count the reads density.
        """
    ...
    def roll_density(self):
        """Calculate the reads rolling polysome density with multi-thread.
        ...
        2. Delete the reverse reads.
        3. Filter the reads length.
        4. Count the reads density with rolling polysome.
        """
    ...
    def calculate_density(self):
        ...
        -----
        Legacy input information:
        - ``self.rolling``: bool, True for rolling polysome, False for monosome.
    ...
    def format_reads(args):
        ...
        -------
        object
            dataframe contain the reads density.
        ...
        Workflow
        --------
        1. Trim the cds frame to fit the 3nt periodicity.
        2. Trim the reads density.
        3. Format the reads density.
        4. Merge the reads density.
        """
