...
class Metaplot(object):
    ...
    def gene_anno(self):
        ...
        - ``self.utr5``: input utr5 length.
        - ``self.cds``: input cds length.
        - ``self.utr3``: input utr3 length.
        - ``self.transcript``: input transcript file.

        Legacy return information:
        - ``self.gene``: output gene table.

        Workflow
        --------
        1. Import the transcript file.
        2. Filter the transcript file with the input utr5/cds/utr3 length.
        3. Output the gene table.
        """
    ...
    def read_rpf(self):
        ...
        Workflow
        --------
        1. Import the rpf file.
        2. Filter the rpf file with the input gene id.
        3. Output the rpf file.
        """
