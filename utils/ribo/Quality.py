...
class Quality(object):
    ...
    def read_transcript(self):
        """Read the transcript file and store the information into a dict.
        ...
        - ``self.mrna_file``: the path of transcript file.

        Legacy return information:
        - ``self.mrna_dict``: the dict of transcript information.

        Workflow
        --------
        1. Open the transcript file.
        2. Read the transcript file and store the information into a dict.
        """
    ...
    def fliter_mrna_reads(self):
        """Retrieve the corrected rpf reads from bam file.
        ...
        -----
        Legacy input information:
        - ``self.sample_file``: the input bam file.
        - ``self.sample_format``: the input bam file format.

        Legacy return information:
        - ``self.pysam_input``: the input bam file.
        - ``self.pysam_output``: the output bam file.

        Workflow
        --------
        1. Check the bam file format.
        2. Check the reads aligner algorithm of bam file.
        3. Import the bam file.
        4. Return the input and output bam file.
        """
    ...
    def rpf_saturation(self):
        ...
        -----
        Legacy input information:
        - ``self.bam_seq_dict``: dict, {read_name: [gene1, gene2, ...]}.

        Legacy return information:
        - ``self.mrna_dict``: dict, {gene1: [site1, site2, ...]}.

        Workflow
        --------
        1. Create the empty dict for resample steps and mrna count.
        2. Create the function to resample the reads.
        3. Runt the resample reads function.
        4. Create the function to fill the empty mrna count dict.
        5. Fill the empty mrna count dict.
        """
