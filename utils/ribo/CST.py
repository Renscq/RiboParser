...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for CST analysis.
...
class CodonSelectiveTime(object):
    ...
    def import_density(self):
        """Import the Ribo-seq and RNA-seq density file. By default, the two data names are different.
        ...
        2. Import the rna density.
        3. Check the samples number.
        """
    ...
    def merge_rpf_rna(self):
        """Get the overlap gene from rpf and mrna density file. only these genes will submit to follow analysis. PS: the gene name should be the same in the two density file.
        ...
        -----
        Legacy input information:
        - rpf_gene/rna_gene --> high expression gene name.
        - high_rpf/high_rna --> high expression gene density.

        Legacy return information:
        - high_rpf/high_rna --> filtered high expression gene density.
    ...
    def make_codon_table(self, rpf_sample=None):
        ...
        Legacy return information:
        - ``codon_table``: codon message table.

        Workflow
        --------
        1. Create the class for each codon.
        2. Merge the codon message.
        """
    ...
    def filter_rpf_rna_expr(self, rpf_sample=None, rna_sample=None):
        ...
        Legacy return information:
        - ``high_rpf``: filtered high expression gene density.
        ...
        Workflow
        --------
        1. Filter the high expression gene with rpf > self.rpf_num.
        2. Check the high expression gene.
        3. Filter the high expression gene density.
        4. Summary the total rpf/reads and rna/reads.
        """
    ...
    def make_gene_table(self, rpf_sample=None, rna_sample=None):
        ...
        Legacy return information:
        - ``gene_table``: gene table contain the [codon count, gene length, codon
        number, rpf, rna, density, elongate rate, initiate rate].

        Workflow
        --------
        1. Create the class for each gene.
        2. Summary the [codon count, gene length, codon number, rpf, rna, density].
        3. Calculate the density with the formula: density = rpf / rna.
        """
    ...
    def ribo_codon_frequency(self, rpf_sample=None):
        ...
        Legacy return information:
        - ``codon_table``: codon message table contain the [rpf codon sum, rpf codon
        val, rpf sum, rpf proportion].

        Workflow
        --------
        1. Create the class for each codon.
        2. Summary the [rpf codon sum, rpf codon val, rpf sum, rpf proportion].
        - rpf_codon_proportion = Σ(codon) / Σ(gene count).
        3. Merge the codon message.
        """
    ...
    def mrna_codon_frequency(self, rpf_sample=None, rna_sample=None, times=0, initiate_rate=None):
        ...
        """Calculate the mean rna density of codon.
        ...
        Legacy return information:
        - ``codon_table``: codon message table contain the [rna codon sum, rna codon
        val, rna sum, rna proportion, cst].

        Workflow
        --------
        1. Create the class for each codon.
        2. Summary the [rna codon sum, rna codon val, rna sum, rna proportion] with the
        formula:.
        - mrna_codon_proportion = Σ(codon) / Σ(gene count).
        3. Calculate the cst with the formula:.
        - cst = rpf_codon_proportion / mrna_codon_proportion.
        4. Merge the codon message.
        """
    ...
    def codon_elongate_rate(self, rpf_sample=None, codon_num=None, codon_dict=None, times=0):
        ...
        rpf_sample : object, optional
            sample name.
        codon_num : object, optional
            total codon number of each gene.
        codon_dict : object, optional
            codon count.
        times : object, optional
            iterative times.
        ...
        -------
        object
            elongate rate for each codon of gene.

        Workflow
        --------
        1. Calculate the codon density.
        2. Calculate the elongate rate with the formula: elongate_rate = codon_num /
        Σ(count * CST)).
        """
    ...
    def compute_cst_iterative(self, rpf_sample=None, rna_sample=None):
        ...
        - ``self.overlap_gene``: high expression gene name in the Ribo-seq and RNA-seq
        data.

        Legacy return information:
        - ``gene_table``: gene table contain the [elongate rate, initiate rate].

        Workflow
        --------
        1. Calculate the elongate rate for each codon of gene.
        - formula: elongate_rate = codon_num / Σ(count * CST)).
        2. Calculate the initiate rate for each gene.
    ...
    def calc_cst(self):
        ...
        Legacy return information:
        - ``codon_cst_table``: codon cst table contain the.
        - [rpf codon sum, rpf codon val, rpf sum, rpf proportion].
        - [rna codon sum, rna codon val, rna sum, rna proportion, cst].

        Workflow
        --------
        1. Make the codon message table.
        2. Calculate the mean rpf density of codon.
        3. Calculate the mean rna density of codon.
        4. Make the gene table.
        5. Calculate the elongate rate for each codon of gene.
        6. Compute cst iteratively.
        """
    ...
    def format_cst_results(self):
        """Format the codon selection time results.
        ...
        -----
        Legacy input information:
        - ``self.codon_table``: codon message table.
        - ``self.rpf_sample``: sample name.
        - ``self.codon_dict``: codon message.

        Legacy return information:
        - ``self.detail_cst``: details of codon selection time results.
        ...
        Workflow
        --------
        1. Merge all codon selection time.
        2. Retrieve the absolute and relative codon selection time.
        3. Retrieve the absolute and relative codon selection time.
        4. Merge the absolute and relative codon selection time.
        """
