...
# Date: 2026-06-12
# Version: 0.2.7
# Function: Provide RiboParser core functions for Percentage analysis.
...
class Percentage(object):
    ...
    def calc_density_percent(self):
        """Calculate the gene rpf density percentage of each gene.
        ...
        -----
        Legacy input information:
        - ``gene_rpf``: gene rpf dataframe.

        Legacy return information:
        - ``gene_rpf``: gene rpf density dataframe.

        Workflow
        --------
        1. Calculate the gene rpf density.
        """
    ...
    def draw_rpf_histogram(self):
        """Draw the rpf histogram of the gene.
        ...
        -----
        Legacy input information:
        - ``self.gene_coverage``: the gene coverage dataframe.
        ...
        Workflow
        --------
        1. Draw the rpf histogram of the gene.
        """
    ...
    def draw_rpf_boxplot(self):
        """Draw the boxplot of the percentage.
        ...
        Workflow
        --------
        1. Draw the rpf boxplot of the gene.
        """
    ...
    def output_density_percent(self):
        """Output the gene rpf density percentage.
        ...
        Workflow
        --------
        1. Output the gene rpf density percentage.
        """
