...
# Date: 2026-06-12
# Version: 0.2.7
# Function: This script is used to merge the reads offset files.
...
def process_offset_files(offset_list):
    ...
    - ``list``: pattern for reads offset files (e.g., '*RSBM_offset.txt').
...
def output_table(offset_merge, output_file):
    ...
    -----
    Legacy input information:
    - ``result_dict``: nested dict contain the reads offset.
