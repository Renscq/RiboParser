...
# Date: 2026-06-12
# Version: 0.2.7
# Function: This script is used to create the list of density files.
...
def process_density_files(density_list):
    """Merge the list file path and name.
    ...
    - ``list``: pattern for density files (e.g., '*_rpf.txt').
