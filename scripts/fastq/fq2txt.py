...
# Date: 2026-06-12
# Version: 0.2.7
# Function: This script is used to convert the FQ to TXT format.
...
def parse_args():
    ...
    required.add_argument(
        "-i", metavar="fq", required=True, type=str, help="input FQ sequence file"
    )
    required.add_argument(
        "-o", metavar="txt",  required=True, type=str,
